...
plot(dateTime, as.numeric(levels(SubData$Global_active_power)[SubData$Global_active_power]), type="l", xlab=NA, ylab="Global Active Power (kilowatts)")

plot(dateTime, as.numeric(levels(SubData$Voltage)[SubData$Voltage]), type="l", ylab="Voltage")
...
plot(dateTime, as.numeric(levels(SubData$Global_reactive_power)[SubData$Global_reactive_power]), type="l", ylab="Global_reactive_power")
